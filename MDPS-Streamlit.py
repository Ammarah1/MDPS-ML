...
MODEL_PATHS = {
    "diabetes_model": os.path.join(MODELS_DIR, "diabetes_best_model_KNN.sav"),
    "diabetes_scaler": os.path.join(MODELS_DIR, "diabetes_scaler.sav"),
    "heart_model": os.path.join(MODELS_DIR, "heart_best_model_RandomForest.sav"),
    "heart_scaler": os.path.join(MODELS_DIR, "heart_scaler.sav"),
    "parkinsons_model": os.path.join(MODELS_DIR, "parkinsons_best_model.sav"),
    "parkinsons_scaler": os.path.join(MODELS_DIR, "parkinsons_scaler.sav")
}
