...
# Paths to the models and scaler files (directly in the root directory)
MODEL_PATHS = {
    "diabetes_model": "diabetes_best_model_KNN.sav",
    "diabetes_scaler": "diabetes_scaler.sav",
    "heart_model": "heart_best_model_RandomForest.sav",
    "heart_scaler": "heart_scaler.sav",
    "parkinsons_model": "parkinsons_best_model.sav",
    "parkinsons_scaler": "parkinsons_scaler.sav"
}
